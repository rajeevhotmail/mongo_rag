...
class RAGEngine:
    ...
    def retrieve_relevant_chunks(
        ...
        print(f"%%%%%%%%%%%%%%%%%%%%Searching for similar chunks: {expanded_query}, top_k={initial_k}")
        results = self.embedding_manager.search_similar_chunks_ex(expanded_query, top_k=initial_k)
